...
export default function Home({products}) {
    ...
    <div class="pt-6">
      ...
      <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
        ...
        <div class="mt-4 lg:row-span-3 lg:mt-0">
          ...
          <p class="text-3xl tracking-tight text-gray-900">{products.price}</p>
              ...
              <fieldset class="mt-4">
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <label class="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none ring-gray-400">
                    ...
                    <span id="color-choice-0-label" class="sr-only">{products.color}</span>
                  ...
                  <label class="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none ring-gray-900">
                    ...
                    <span id="color-choice-2-label" class="sr-only">{products.price}</span>
  ...
  export async function getStaticProps({params}) {
    ...
    const products=  dataById(productId)
    return {
      props: {
        products
      },
